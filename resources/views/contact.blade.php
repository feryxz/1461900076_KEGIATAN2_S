...
<head>
    ...
    <title>Contact Us - Feryxz Developer</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a href="/absen" class="nav-link"><span data-hover="Home">Home</span></a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 mr-lg-5 col-12">
                    <div class="google-map w-100">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15829.36292783879!2d112.7986888!3d-7.3155671!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xea69a8e500c39068!2sFeryxz%20Developers%20-%20Jasa%20Pembuatan%20Website%20Surabaya!5e0!3m2!1sid!2sid!4v1621680366178!5m2!1sid!2sid" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>

                    <div class="contact-info d-flex justify-content-between align-items-center py-4 px-lg-5">
                        <div class="contact-info-item">
                            <h3 class="mb-3 text-white">Feryxz Developer</h3>
                            <p class="footer-text mb-0">+62 899-9218-991</p>
                            <p><a href="mailto:feryxz.dev@gmail.com">feryxz.dev@gmail.com</a></p>
                        </div>

                        <ul class="social-links">
                            <li><a href="#" class="uil uil-dribbble" data-toggle="tooltip" data-placement="left" title="Dribbble"></a></li>
                            <li><a href="https://www.instagram.com/feryxz/" target="_blank" class="uil uil-instagram" data-toggle="tooltip" data-placement="left" title="Instagram"></a></li>
